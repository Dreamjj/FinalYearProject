...
public class TestEquivMeasures09 extends TestCase
{
	// constructor
	public TestEquivMeasures09(String name)
	{
		super(name);
	}
	...
	@Test
	public void testEquivMeasures09() throws Exception
	{
	  ...
	  // test orbit-cluster equivalence, and clustering similarity
		...
		assertEquals((2.0 / 3.0), equivalence);
		assertEquals(0.0, similarity);
		
	} // testEquivMeasures

} // class TestEquivMeasures09
