...
public class TestClusteringsGraph03_2 extends TestCase
{
	...
	// constructor
	public TestClusteringsGraph03_2(String name, String requiredDirectory)
	{
		super(name);
		directory = requiredDirectory + "\\graph03_2.gml";
	}
	...
	@Test
	public void testClusteringsG03_2() throws Exception
	{
	  ...
	  // test the k-means clusterings (k = 2) are as expected
		...
		expectedCluster5.add(inputVertexSet[2]);
...
} // class TestClusteringsGraph03_2
