...
public class TestEquivMeasures13 extends TestCase
{
	// constructor
	public TestEquivMeasures13(String name)
	{
		super(name);
	}
	...
	@Test
	public void testEquivMeasures13() throws Exception
	{
	  ...
	  // create the k-means clusterer (using 2nd constructor to bypass calculations)
		...
		cluster1.add(vertexC);
		cluster1.add(vertexD);
	  ...
	  // test orbit-cluster equivalence, and clustering similarity
		...
		assertEquals(0.9, equivalence);
		assertEquals(0.6, similarity);
		
	} // testEquivMeasures

} // class TestEquivMeasures13
