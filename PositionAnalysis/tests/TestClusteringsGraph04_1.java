...
public class TestClusteringsGraph04_1 extends TestCase
{
	...
	// constructor
	public TestClusteringsGraph04_1(String name, String requiredDirectory)
	{
		super(name);
		directory = requiredDirectory + "\\graph04_1.gml";
	}
	...
	@Test
	public void testClusteringsG04_1() throws Exception
	{
	  // test the orbits are as expected
		...
		expectedOrbit1.add(inputVertexSet[3]);
...
} // class TestClusteringsGraph04_1
