...
public class TestEquivMeasures11 extends TestCase
{
	// constructor
	public TestEquivMeasures11(String name)
	{
		super(name);
	}
	...
	@Test
	public void testEquivMeasures11() throws Exception
	{
	  ...
	  // create the k-means clusterer (using 2nd constructor to bypass calculations)
		...
		ArrayList<Vertex> cluster4 = new ArrayList<Vertex>();
		ArrayList<Vertex> cluster5 = new ArrayList<Vertex>();
		cluster1.add(vertexA);
		cluster2.add(vertexB);
		cluster3.add(vertexC);
		cluster4.add(vertexD);
		cluster5.add(vertexE);
	  ...
	  // test orbit-cluster equivalence, and clustering similarity
		...
		assertEquals(0.8125, equivalence);
		assertEquals(0.4, similarity);
		
	} // testEquivMeasures

} // class TestEquivMeasures11
