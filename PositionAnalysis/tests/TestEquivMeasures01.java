...
public class TestEquivMeasures01 extends TestCase
{
	// constructor
	public TestEquivMeasures01(String name)
	{
		super(name);
	}
	...
	@Test
	public void testEquivMeasures01() throws Exception
	{
		// create the vertices used in the test
		Vertex vertexA = new Vertex(0, "A");
		Vertex[] vertexSet = {vertexA};
	  ...
	  // create a new position analysis with the secondary constructor
		...
		Double similarity = new Double(positionAnalysis.getSimilarityOfClusters());
		assertEquals(1.0, equivalence);
		assertTrue(similarity.isNaN());
		
	} // testEquivMeasures

} // class TestEquivMeasures01
