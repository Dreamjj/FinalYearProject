...
public class TestEquivMeasures17 extends TestCase
{
	// constructor
	public TestEquivMeasures17(String name)
	{
		super(name);
	}
	...
	@Test
	public void testDifferingElements17() throws Exception
	{
		...
		Vertex[] vertexSet1 = {vertexA, vertexC};
		Vertex[] vertexSet2 = {vertexB, vertexC};
