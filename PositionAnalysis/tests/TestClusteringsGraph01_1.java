...
public class TestClusteringsGraph01_1 extends TestCase
{
	...
	// constructor
	public TestClusteringsGraph01_1(String name, String requiredDirectory)
	{
		super(name);
		directory = requiredDirectory + "\\graph01_1.gml";
	}
	...
	@Test
	public void testClusteringsG01_1() throws Exception
	{
	  ...
	  // test the k-means clusterings (k = 0) are as expected
		// -- exception (must be a positive number of clusters)
		try 
		{
...
} // class TestClusteringsGraph01_1
